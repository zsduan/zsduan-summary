...
<template>
    <div>
        <dzs-header title="微信/支付宝/其他浏览器"></dzs-header>
        <div class="page">
            <h2>基础用法</h2>
            <div class="item">
                <div class="tips-box">点按钮直接打开</div>
                <el-button type="primary" @click="is_wx_Alipays">点我获取</el-button>
                <div class="guid">{{is_wx_Alipay}}</div>
...
export default {
    ...
    methods:{
        is_wx_Alipays(){
            this.is_wx_Alipays = is_wx_Alipays;
        }
    }
}
</script>
