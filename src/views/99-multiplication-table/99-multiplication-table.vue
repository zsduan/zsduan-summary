...
<template>
    <div>
        <dzs-header title="99乘法表" v-if="!newIndex"></dzs-header>
        <div class="page">
            <h2>生成乘法表 填写空数组</h2>
            <div class="item">
                <div class="multiplicationTable">
                    <ul class="multiplicationTable-item" v-for="(item,index) in multiplicationTable" :key="index">
                        <li
                            :class="[itm.is_invalid ? 'active' : '' , itm.left == 1 ? 'left-border' : '' , itm.right == 9 ? 'bottom-border' : '']"
            ...
            <h2>源代码下载/查看</h2>
            <div class="item">
                <a target="_blank" href="https://github.com/zsduan/zsduan-summary/blob/master/src/utils/99-multiplication-table.js">下载/查看地址</a>
            </div>
        </div>
