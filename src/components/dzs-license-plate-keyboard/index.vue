<template>
    <div class="keyboard-box">
        <div :id="keyboardId" :class="isShow ? 'keyboard-height' : 'keyboard-bottom'" class="keyboard"
            :style="{ bottom: bottom }">
            <!--省份简称键盘-->
            <div class="com-btn">
...
<script>
/**
 * @props {Boolean} isShow 是否显示键盘  
 * @props {String} bottom 距离底部的距离
 * @methods complete 点击完成
 * @methods change 点击改变事件
 * @methods del 点击删除事件
 * @methods validatePlateNumber 基础的车牌号校验 ref调用
*/
export default {
