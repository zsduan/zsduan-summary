...
export default {
    ...
    methods: {
        generateCode() {
            ...
            let show_num = [];
            let canvas_width = this.$refs.dzs_code_canvans.width;
            let canvas_height = this.$refs.dzs_code_canvans.height;
            let canvas = this.$refs.dzs_code_canvans; //获取到canvas的对象
